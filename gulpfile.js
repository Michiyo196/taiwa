...
const changed = require("gulp-changed");//変更したファイルのみにタスク実行
...
const srcPath = {
  'scss': './wp/wp-content/themes/taiwa/sass/**/*.scss',
  'html': srcBase + '/**/*.html',
  'img': assetsBase + '/images_moto/**/*'
};

const distPath = {
  'css': './wp/wp-content/themes/taiwa/css',
  'html': distBase + '/',
  'img': './wp/wp-content/themes/taiwa/'
};
...
const cssSass = () => {
  return gulp.src(srcPath.scss, {
    ...
    .pipe(gulp.dest(distPath.css, { sourcemaps: './maps' })) //コンパイル先
...
exports.default = gulp.series(
  gulp.parallel( cssSass, imgImagemin),
